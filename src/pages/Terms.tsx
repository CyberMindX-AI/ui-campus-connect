...
import { FileText, ShieldCheck, Users, AlertTriangle, DollarSign, Scale, MessageCircle, Star, ArrowRight } from 'lucide-react';
      ...
      <div className="container mx-auto max-w-3xl px-4 py-8 sm:py-12">
        ...
        {isFromSignup && (
          <div className="mt-12 sticky bottom-8 flex justify-center">
            <Button 
              size="lg" 
              className="gap-2 shadow-2xl shadow-primary/40 px-8 py-6 text-lg rounded-2xl"
              onClick={handleContinue}
            >
              I Accept & Continue to Dashboard <ArrowRight className="h-5 w-5" />
            </Button>
          </div>
        )}
      </div>
